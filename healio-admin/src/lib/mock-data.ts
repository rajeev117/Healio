...
export const providers: Provider[] = [
  { id: 'dr1', name: 'Dr. Ananya Joshi',  type: 'doctor', role: 'doctor' as Provider['role'], linked: true,       specialty: 'General Physician',    orgId: 'org1', orgName: 'Healio City Hospital', status: 'active',               verifiedAt: '2025-01-16', rating: 4.9, joinedAt: '2025-01-16' },
  { id: 'dr2', name: 'Dr. Sameer Gupta',  type: 'doctor', role: 'doctor' as Provider['role'], linked: true,       specialty: 'Cardiologist',          orgId: 'org1', orgName: 'Healio City Hospital', status: 'active',               verifiedAt: '2025-02-05', rating: 4.7, joinedAt: '2025-02-05' },
  { id: 'dr3', name: 'Dr. Pooja Nair',    type: 'doctor', role: 'doctor' as Provider['role'], linked: true,       specialty: 'Dermatologist',         orgId: 'org2', orgName: 'LifeCare Clinic',      status: 'active',               verifiedAt: '2025-03-11', rating: 4.8, joinedAt: '2025-03-11' },
  { id: 'dr4', name: 'Dr. Rajesh Iyer',   type: 'doctor', role: 'doctor' as Provider['role'], linked: false,       specialty: 'Orthopaedic Surgeon',   orgId: 'org1', orgName: 'Healio City Hospital', status: 'pending_verification', rating: 0,   joinedAt: '2026-06-10' },
  { id: 'lt1', name: 'Anand Verma',       type: 'lab', role: 'lab_technician' as Provider['role'], linked: true,          specialty: 'Lab Technician',        orgId: 'org3', orgName: 'Healio Diagnostics',  status: 'active',               verifiedAt: '2025-02-21', rating: 4.6, joinedAt: '2025-02-21' },
  { id: 'ph1', name: 'Sunita Desai',      type: 'pharmacy', role: 'pharmacy_assistant' as Provider['role'], linked: true,     specialty: 'Pharmacist',            orgId: 'org4', orgName: 'Healio Pharmacy',      status: 'active',               verifiedAt: '2025-02-21', rating: 4.5, joinedAt: '2025-02-21' },
  { id: 'rp1', name: 'Mahesh Yadav',      type: 'rmp' as any, role: 'doctor' as Provider['role'], linked: true,   specialty: 'Healthcare Consultant',           orgId: '',     orgName: 'Independent (Wagholi)', status: 'active',              verifiedAt: '2025-04-01', rating: 4.3, joinedAt: '2025-04-01' },
  { id: 'rp2', name: 'Sunita Kale',       type: 'rmp' as any, role: 'doctor' as Provider['role'], linked: true,   specialty: 'Healthcare Consultant',           orgId: '',     orgName: 'Independent (Kharadi)', status: 'active',              verifiedAt: '2025-05-12', rating: 4.1, joinedAt: '2025-05-12' },
];
