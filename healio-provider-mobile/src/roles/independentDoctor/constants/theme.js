// Individual-doctor palette. Same Healio brand colours as every other module —
// the separation is in the surface language, not the hue: a warm canvas instead
// of the cool grey the hospital-affiliated doctor module sits on, a blush-tinted
// border, and an asymmetric header radius (see SIZES.headerRadius*).
//
// Deliberately identical to independentLab/independentPharmacy: the three
// standalone provider modules should read as one family, distinct from the
// hospital-scoped screens.
export const COLORS = {
  primary: '#821c03',
  primaryDeep: '#5e1402',
  secondary: '#fdf2f0',
