...
export default function Profile({ navigation }) {
  ...
  useFocusEffect(useCallback(() => {
    fetchOrgInfo(orgId)
      .then(setOrg)
      .catch(e => console.warn('Independent pharmacy profile:', e.message))
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={styles.badge}>
            <Text style={styles.badgeText}>Independent pharmacy</Text>
          </View>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Pharmacy info</Text>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Run the counter</Text>
          <MenuItem icon="cube-outline"          label="Inventory & stock"  onPress={() => navigation.navigate('Main', { screen: 'Stock' })} />
          <MenuItem icon="qr-code-outline"       label="My QR code"         onPress={() => navigation.navigate('PharmacyQR')} />
          <MenuItem icon="receipt-outline"       label="Order requests"     onPress={() => navigation.navigate('OrderRequests')} />
