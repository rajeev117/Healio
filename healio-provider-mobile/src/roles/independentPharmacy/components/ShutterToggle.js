// The open/closed shutter. An independent provider owns its own hours — this is
// the control a hospital-affiliated module has no equivalent of, so it leads
// every independent home screen.
//
// Local-only for now: there is no opening-hours column on organisations. Stored
// per device so the counter reopens where it left off.
