...
// when the patient has scanned THIS pharmacy's QR in the last 24h — the scan is
// the consent. A direct select on `prescriptions` would return nothing here:
// that policy keys on my_org_id(), which is null for an org admin, and an
// independent pharmacy's script was written at someone else's hospital anyway.
    ...
    return (
      <View style={[styles.card, styles.empty]}>
        ...
        <Text style={styles.emptyBody}>
          Ask the patient to scan your counter QR. That scan is what shares their prescriptions with you,
