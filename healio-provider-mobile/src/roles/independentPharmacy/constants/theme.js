// Independent-pharmacy palette. Identical Healio brand colours to every other
// module — the separation is the surface language: a warm canvas instead of the
// cool grey the hospital-affiliated modules sit on, a blush-tinted border, and
// an asymmetric header radius (see SIZES.headerRadius*).
export const COLORS = {
  primary: '#821c03',
  primaryDeep: '#5e1402',
  secondary: '#fdf2f0',
