...
// Renders a patient's lab-order images grouped date-wise (newest first), each
// labeled with the prescribing doctor. Tapping the card opens a full-screen
// viewer; the Checkout button opens the billing screen for that order.
              ...
              <TouchableOpacity style={styles.rxMain} onPress={() => setPreview(rx)}>
                ...
                <View style={styles.rxInfo}>
                  ...
                  <View style={styles.imageBadge}>
                    ...
                    <Text style={styles.imageBadgeText}>Lab order image</Text>
                  </View>
                </View>
