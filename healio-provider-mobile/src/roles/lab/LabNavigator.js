// ─────────────────────────────────────────────────────────────────────────────
// LabNavigator — the diagnostic-lab-partner portal, namespaced as a role module
// inside the unified Healio app.
//
// Lifted from the standalone labs app's App.js. The unified shell owns the
// NavigationContainer/SafeAreaProvider and authentication; labs are
// hospital-affiliated staff (role 'lab_technician'), so there is no self-serve
// signup and the module's own Login screen is not registered here.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function LabNavigator({ initialRouteName = 'Main' }) {
  return (
    <Stack.Navigator
