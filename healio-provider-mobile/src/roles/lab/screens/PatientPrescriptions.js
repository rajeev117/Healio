...
import PrescriptionImageList from '../components/PrescriptionImageList';
            ...
            >
              ...
              {rx.medicines && rx.medicines.length > 0 && (
                <View style={styles.rxMeds}>
                  <Text style={styles.rxMedsLabel}>Tests / Medicines:</Text>
                  <Text style={styles.rxMedsText}>
                    {rx.medicines.map(m => m.name || m).join(', ')}
                  </Text>
                </View>
              )}
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  ordersBadge: {
    backgroundColor: COLORS.secondary, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10,
  },
