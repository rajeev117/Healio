    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={styles.tagline}>Lab Portal</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.cardTitle}>Welcome back</Text>
        <Text style={styles.cardSub}>Enter your registered mobile number to manage lab orders and earnings</Text>
      ...
      <Text style={styles.footer}>For registered hospital labs only</Text>
    </SafeAreaView>
  );
}
