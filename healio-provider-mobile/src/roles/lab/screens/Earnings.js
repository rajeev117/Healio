...
import { fetchLabEarnings } from '../services/api';
...
export default function Earnings() {
  ...
  useFocusEffect(useCallback(() => {
    ...
    fetchLabEarnings(hospitalId)
      .then(setEarnings)
      .catch(e => console.warn('Lab Earnings error:', e.message))
...
const styles = StyleSheet.create({
  ...
  periodRow: {
    ...
    borderRadius: 12, padding: 4, marginBottom: SPACING.l,
  },
  ...
  card: {
    ...
    marginHorizontal: 20, marginTop: 16, borderWidth: 1, borderColor: COLORS.border,
  },
