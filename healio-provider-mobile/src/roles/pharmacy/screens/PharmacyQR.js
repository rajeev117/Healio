      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false} contentContainerStyle={{ alignItems: 'center' }}>
        <View style={styles.qrCard}>
          <View style={styles.qrTop}>
            ...
            <View>
              <Text style={styles.qrPharmacy}>{hospitalName}</Text>
              <Text style={styles.qrLicense}>Pharmacy Department</Text>
            </View>
          </View>
          <View style={styles.qrFrame}>
            <QRCode value={`healio:pharmacy:${hospitalId}`} size={220} color={COLORS.primary} backgroundColor={COLORS.white} />
          </View>
        ...
        <TouchableOpacity style={styles.pendingBtn} onPress={() => navigation.navigate('Main', { screen: 'Prescriptions' })}>
          ...
          <Text style={styles.pendingBtnText}>Go to Prescriptions</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  qrPharmacy: { fontSize: 16, fontWeight: '800', color: COLORS.text },
